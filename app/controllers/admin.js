...
export default Ember.Controller.extend({
  /*
    ...
    practice. Once again, the current backend is temporary anyway.
  */
  ...
  //The will return the hashed value of the correct admin password
  getAdminPass: function() {
    var r = 0; 
    this.store.findRecord('admin-password', 'pass1').then(function(adminPassword) {
      return adminPassword.get('hash');
    });
    return r;
  },
